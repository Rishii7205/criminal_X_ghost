...
PING_IMG_URL = getenv(
    "PING_IMG_URL",
    "https://telegra.ph//file/510af66387e0dfc4ebce1.jpg",
)
...
if PING_IMG_URL:
    if PING_IMG_URL != "assets/Ping.jpeg":
        if not re.match("(?:http|https)://", PING_IMG_URL):
            PING_IMG_URL = "https://telegra.ph//file/510af66387e0dfc4ebce1.jpg"

if START_IMG_URL:
    if START_IMG_URL != "assets/Ping.jpeg":
        if not re.match("(?:http|https)://", START_IMG_URL):
            START_IMG_URL = "https://telegra.ph//file/8fb37bf467bc7f6261866.jpg"
